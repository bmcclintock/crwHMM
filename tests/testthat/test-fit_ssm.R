...
test_that("fit_ssm defaults + crw + KF return crwHMM list w 13 elements", {
  expect_s3_class(f$ssm[[1]], "crwHMM")
  expect_equal(length(f$ssm[[1]]), 13)
})

f <- fit_ssm(dls, model = "crw", time.step = 24)
test_that("fit_ssm defaults + crw + LS return crwHMM list w 13 elements", {
  expect_s3_class(f$ssm[[1]], "crwHMM")
  expect_equal(length(f$ssm[[1]]), 13)
})
...
test_that("fit_ssm defaults + rw return crwHMM list w 13 elements", {
  expect_s3_class(f$ssm[[1]], "crwHMM")
  expect_equal(length(f$ssm[[1]]), 13)
})
...
test_that("fit_ssm vmax + crw return crwHMM list w 13 elements", {
  expect_s3_class(f$ssm[[1]], "crwHMM")
  expect_equal(length(f$ssm[[1]]), 13)
})
...
test_that("fit_ssm vmax,ang + crw return crwHMM list w 13 elements", {
  expect_s3_class(f$ssm[[1]], "crwHMM")
  expect_equal(length(f$ssm[[1]]), 13)
})
...
test_that("fit_ssm vmax,ang,min.dit + crw return crwHMM list w 13 elements", {
  expect_s3_class(f$ssm[[1]], "crwHMM")
  expect_equal(length(f$ssm[[1]]), 13)
})
...
test_that("fit_ssm no spd filter + crw return crwHMM list w 13 elements", {
  expect_s3_class(f$ssm[[1]], "crwHMM")
  expect_equal(length(f$ssm[[1]]), 13)
})
...
test_that("fit_ssm optim + crw return crwHMM list w 13 elements", {
  expect_s3_class(f$ssm[[1]], "crwHMM")
  expect_equal(length(f$ssm[[1]]), 13)
})
...
test_that("fit_ssm full data + crw return crwHMM list w 13 elements", {
  expect_s3_class(f$ssm[[1]], "crwHMM")
  expect_equal(length(f$ssm[[1]]), 13)
})
...
test_that("fit_ssm verbose + crw return crwHMM list w 13 elements", {
  expect_s3_class(f$ssm[[1]], "crwHMM")
  expect_equal(length(f$ssm[[1]]), 13)
})
...
test_that("fit_ssm inner.control + crw return crwHMM list w 13 elements", {
  expect_s3_class(f$ssm[[1]], "crwHMM")
  expect_equal(length(f$ssm[[1]]), 13)
})
...
test_that("fit_ssm multi-track returns crwHMM lists w 13 elements", {
